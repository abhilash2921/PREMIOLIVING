...
window.ProcurementPage = {
  ...
  activeTab: 'rfqs', // 'rfqs' | 'comparisons' | 'pos' | 'rates'
  activeSearch: '',
  activeRFQId: null,
  ...
  renderProcurementDashboard(container, project) {
    ...
    container.innerHTML = `
      <div class="max-w-6xl mx-auto space-y-6">
        ...
        <div class="flex border-b border-border-color/60 gap-4 text-xs pb-1 overflow-x-auto no-scrollbar animate-fade-in">
